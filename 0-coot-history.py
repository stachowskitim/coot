...
set_display_intro_string ("Good Morning Stachowski,, Welcome to Coot version 0.9.8.92")
use_graphics_interface_state ()
...
get_active_map_drag_flag ()
use_graphics_interface_state ()
set_display_intro_string ("Good morning Stachowski,. Welcome to Coot 0.9.8.92")
